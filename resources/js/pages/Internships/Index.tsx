                                ...
                                >
                                    ...
                                    <div className="space-y-3 text-sm text-gray-600 border-t pt-4">
                                        ...
                                        <p className="flex justify-between items-center">
                                            ...
                                            <span className="truncate font-semibold text-gray-800">{internship.company?.nom_complet || 'N/A'}</span>
                                        </p>

                                        {/* Ville */}
                                        <p className="flex justify-between items-center">
                                            <span className="font-medium text-gray-500">Ville :</span>
                                            <span className="font-semibold text-gray-800">{internship.company?.siege.city?.nom || 'Inconnue'}</span>
                                        </p>
