    ...
    const handleSubmit = (e: FormEvent) => {
        ...
        post('/admin/teachers', {
            onSuccess: () => {
                ...
                setHasTouched({}); // Réinitialiser les champs touchés
            },
            onError: (errors) => {
            ...
            <main className="flex min-h-screen p-8 bg-gray-50">
                ...
                <div className='flex-1 p-8'>
                    <div className="mx-auto max-w-4xl rounded-lg bg-white p-8 shadow-md">
                        ...
                        {/* ✅ Ajouter onSubmit et lier les inputs avec setData */}
                                ...
                                <div className="mb-6 grid grid-cols-1 gap-6 md:grid-cols-2">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => setData('teacher', { ...data.teacher, firstname: e.target.value })}
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            type="text"
                                            placeholder="Dupont"
                                            value={data.teacher.lastname}
                                            onChange={(e) => setData('teacher', { ...data.teacher, lastname: e.target.value })}
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => setData('teacher', { ...data.teacher, email: e.target.value })}
