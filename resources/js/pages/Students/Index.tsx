                    ...
                    <div className="mx-auto max-w-6xl">
                        ...
                        {students.length === 0 ? (
                            <div className="rounded-lg bg-white p-12 text-center shadow-md">
                                ...
                                <p className="mt-4 text-lg font-medium text-gray-600">Aucun étudiant trouvé</p>
                                <p className="mt-2 text-sm text-gray-500">Commencez par ajouter des étudiants à la base de données.</p>
                            </div>
                        ) : (
                                    ...
                                    >
                                        ...
                                        <div className="mb-4 flex items-center gap-4">
                                            ...
                                            <div className="flex-1">
                                                <p className="text-xs font-medium text-gray-500">Numéro étudiant</p>
                                                <p className="text-sm font-semibold text-blue-600">{student.student_id}</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex gap-2">
                                            <Link
                                                href={`/admin/students/${student.student_id}/internships`}
